...
= Spring Boot Reference Guide 参考指南
...
include::documentation-overview.adoc[文档概述]
include::getting-started.adoc[入门]
include::using-spring-boot.adoc[使用Spring Boot]
include::spring-boot-features.adoc[Spring Boot功能]
include::production-ready-features.adoc[生产就绪功能]
include::deployment.adoc[部署应用]
include::spring-boot-cli.adoc[Spring Boot命令行]
include::build-tool-plugins.adoc[构建工具插件]
include::howto.adoc[使用指南]
include::appendix.adoc[附录]
